...
- Unlike in other package managers, pmfow will only allow you to install one package at a time.
- The repositories have a very limited selection of software.
